...
public class DiseasesDao implements Serializable {
	 ...
	 * @throws Exception
	 */
	public void editarDiseases(Diseases diseases) throws Exception {
		em.merge(diseases);
	}
	 ...
	 * @throws Exception
	 */
	public void guardarDiseases(Diseases diseases) throws Exception {
		em.persist(diseases);
	}
	 ...
	 * @throws Exception
	 */
	public void eliminarDiseases(Diseases diseases) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Long cantidadDiseases(StringBuilder consulta,
	...
	public List<Diseases> consultarDiseases(int start, int range,
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Diseases nombreExiste(String nombre, int id) throws Exception {
		StringBuilder query = new StringBuilder();
		query.append("SELECT d FROM Diseases d ");
