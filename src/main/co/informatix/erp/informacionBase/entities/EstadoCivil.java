...
/**
 * This class maps the marital_status table, which contains information on the
 * different civil status of a person.
 * 
...
public class EstadoCivil implements Serializable {
	...
	/**
	 * 
	 * @return id: Unique identifier of the civil status table.
	 */
	@Id
	 ...
	 * 
	 * @param id
	 *            : Unique identifier of the civil status table.
	 */
	...
	/**
	 * 
	 * @return fechaFinVigencia: End date of the term of the civil state.
	 */
	 ...
	 *            : End date of the term of the civil state.
	 */
