...
public class BeanIndexGeneralTrend implements Serializable {
	...
	/**
	 * This method allow initialize the needles variables to generate Reports by
	 * Section
	 * 
	 * @return rptBySection : display the view to manage the report of the index
	 *         bean by section
	 */
	public String initializeReportBySection() {
		return "rptBySection";
	}
}
